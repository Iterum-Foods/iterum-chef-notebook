...
const TabNavigation = () => {
  ...
  const tabs = [
    ...
    { id: 'service-description', label: 'Products/Services', icon: Target, color: 'purple' },
    { id: 'marketing-strategy', label: 'Marketing', icon: Target, color: 'pink' },
    { id: 'operations-plan', label: 'Operations', icon: Building, color: 'purple' },
    { id: 'management-team', label: 'Management', icon: Users, color: 'indigo' },
    { id: 'financial-projections', label: 'Financial Projections', icon: DollarSign, color: 'green' },
    ...
    { id: 'vendor-management', label: 'Vendor Management', icon: Truck, color: 'orange' },
